...
#----------------------------------------------------------------------------
# Default settings to mimic AGHF results
...
#----------------------------------------------------------------------------
SEASON = 1653 # Hard-coded for the 2022-2023 season

DIVISIONS = get_divisions.populateDivisionsDictionary(SEASON, get_divisions.League.AGHF)

#----------------------------------------------------------------------------
# Read AGHF score data into a ledger. This is specific to the JSON format
...
#----------------------------------------------------------------------------
# AGHF specific: each division gets split into subdivisions, with each
...
# THe AGHF KRACH rankings list other teams as being in the lowest
...
def writeDivisionIndex(toc):
    with open("results/AGHF/readme.md", "w") as f:
